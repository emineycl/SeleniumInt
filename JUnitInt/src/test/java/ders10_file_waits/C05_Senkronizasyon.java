...
public class C05_Senkronizasyon {
    ...
    public void explicitlyWaitTesti(){
        ...
        driver.manage().window().maximize();
         ...
         /*implictly wait tanimlamadigimiz icin butona bastiktan hemen sonra itsgone mesajini bulamaz ve hata verir */
            WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(20));
         /*   WebElement itsGoneElementi= driver.findElement(By.id("message"));
         klasik olarak bir web elementini beklemesini soylemek icin once o web elementi locate etmemiz gerekir
         ...
         Bu tur problemlerde WebElement olusturma , bekleme ve locate ucu bir arada yapilir
            */
