...
public class C01_IlkMavenTest {
    ...
    //  3- “Samsung headphones” ile arama yapalim
     ...
     //  4- Bulunan sonuc sayisini yazdiralim
        ...
        if (Integer.parseInt(sonucSayisiStr)>100) {
            ...
            System.out.println("sonuc sayisi 100'den fazla degil, test FALLED");
        }
    ...
    driver.navigate().back();
        ...
        List<WebElement> baslikElementlerList=driver.findElements(By.xpath("//span[@class=‘a-size-base a-color-base’]"));

        for (WebElement eachelement: baslikElementlerList)
        {
