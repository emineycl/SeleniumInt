 ...
 */
        ...
        WebDriver driver=new ChromeDriver();
         ...
         driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15));  //implicitlyWait seleniumdan geliyor
      ...
      Thread.sleep(1000);
      driver.findElement(By.xpath("//select[@class='input-xlarge']")).sendKeys("Europa" +Keys.ENTER + Keys.ENTER);
      Thread.sleep(1000);
